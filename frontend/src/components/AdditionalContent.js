...
import readingImg from '../assets/fe99fdd3e5cfe5580144445eeb262980.png'; // Adjust path accordingly
import grammarImg from '../assets/108672661-grammar-vector-icon-isolated-on-transparent-background-grammar-logo-concept.jpg';
import speakingImg from '../assets/png-transparent-computer-icons-speech-speaking-miscellaneous-text-logo.png';
